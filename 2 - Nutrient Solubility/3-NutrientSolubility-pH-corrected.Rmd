...
# General
While comparing nutrient concentrations in aquaponic systems reported in literature with theoretical solubilities based on calculations using the solubility product constant $K_{s0}$, reported concentrations are approximately three orders of magnitude higher in case of Ca, Mg, Fe, Mn, Cu, Zn, and P. This could be due to the pH-dependence of the solubility of some salts.
...
```{r Create procdata and recalculate species}
