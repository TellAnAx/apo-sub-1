...
The data acquisition and processing steps are graphically summarised in **FIGURE XXX**. Literature was screened for studies that focussed on nutrient dynamics in aquaponic systems, resulting in an initial dataset (IDS) of 117 individual observations originating from 39 publications. Selected literature comprised studies about permanently and on-demand coupled freshwater aquaponics, sludge remineralisation studies and hydroponic growth trials with water originating from aquaculture systems. The cultivated species, location of the experimental site, pH, volume of the system parts, daily water exchange rate, initial and final bodyweight, stocking density, daily feeding rate, and the concentrations of all essential plant nutrients in the source water, feed, and system water were collected.

![Graphical representation of the data acquition and wrangling steps. Green box: filter applied; red box: external data added; solid line: dataset; dotted line: data derived from initial dataset; dashed line: data derived from external source; thick solid line: final usage of data.](images/data_analysis_flow.png)




## Origin of nutrients
### Data wrangling and derivation of assumptions
To calculate the proportion contribution of the source water, feed and alkalinity supplements to the total daily nutrient input, their average daily inputs had to be calculated. Thus, a filter was applied to the IDS, only including studies that reported system volume or dimensions, daily water exchange rates or volume, initial and final or average bodyweight of the fish stock together with the number of fish or total biomass, or the stocking density, and the feeding rate or total weight of feed given. 
...
The resulting filtered dataset (FDS) held 39 observations from 10 publications. Gathered location information in the FDS was used to search for water analysis reports provided by local authorities and water utilities in the corresponding municipalities. These were merged.
...
![Number of water analysis reports per country included in the source water dataset.](plots/contribution_waterData_countryPlot.png)
