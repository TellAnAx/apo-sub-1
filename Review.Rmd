...
When discussing feed as nutrient input, it is important to consider the digestibility of the nutrients and the route of their excretion. Aquatic animals excrete nutrients both in dissolved form via their gills and the urinary system [@Evans2003] and as solid feces. Consequently, excreted nutrients differ in their plant availability according to the major pathway of excretion.

The excretion of N as endproduct of the protein and amino acid catabolism takes place in form of ammonia and urea. The predominant excretory site are the gills, followed by renal excretion [@Dabrowski; @Mommsen1992] **Fish Nutrition**. 

Approximately 30% of P supplied by the feed is excreted [@Lall1989]. Of this, 90% are excreted via the urine [@Tomiyama1956]. However, excretion can be much higher if plant ingredients rich in phytic acid are used. Phytic acid is poorly digestible and can furthermore reduce the digestibility of minerals in the feed. Consequently, a shift in the excretion pattern is observable with an increasing share of excretion as particulate P.
...
The earth alkaline metals Ca and Mg are primarily excreted in dissolved form via the gills and urine [@Lall1989; @Oikari1985]. Mn, in contrast, is mostly excreted in solid form as feces, while the renal excretion was found to be negligible [@Lall1989]


[@Andreasson1995] Cu, Ni, Zn biliary excretion limited
