...
Overall, the current input scenario confirmed that fish feed, after consideration of its digestibility and nutrient retention by fish, is the major nutrient input route for N, P, K, Fe, Mn, Cu, Zn, and Mo. These results confirm prior findings [@Delaide2017]. Considering variability among locations, it could furthermore be confirmed that Ca, Mg, S, B and Na originate from source water. 
