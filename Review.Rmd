...
```{r pathwaydigestion, echo=FALSE, fig.cap="A simple graphical representation of nutrient flows and excretion patterns in aquatic animals (from Bureau and Hua, 2010)."}
